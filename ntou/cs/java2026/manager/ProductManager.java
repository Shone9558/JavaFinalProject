...
public class ProductManager {
    ...
    public void searchProducts(Scanner scanner) {
        ...
        System.out.println("\n正在搜尋博客來...");
        allProducts.addAll(new BooksCrawler().search(keyword));

        System.out.println("正在搜尋 PChome...");
        allProducts.addAll(new PChomeCrawler().search(keyword));

        System.out.println("正在搜尋 momo...");
        allProducts.addAll(new MomoCrawler().search(keyword));

        System.out.println("正在搜尋 Yahoo購物...");
        allProducts.addAll(new YahooCrawler().search(keyword));
    ...
    public void filterByPrice(Scanner scanner) {
        filteredProducts.clear();
        filteredProducts.addAll(filterManager.filterByPrice(scanner));
    }

    public void filterByPlatform(Scanner scanner) {
        platformFilteredProducts.clear();
        platformFilteredProducts.addAll(filterManager.filterByPlatform(scanner));
    }

    public void addFavorite(Scanner scanner) {
        favoriteManager.addFavorite(scanner, allProducts, filteredProducts, platformFilteredProducts);
    }
