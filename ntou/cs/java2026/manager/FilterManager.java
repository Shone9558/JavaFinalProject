...
public class FilterManager {
    ...
    public List<Product> filterByPrice(Scanner scanner) {
        ...
        for (Product product : allProducts) {
            ...
            if (matchMin && matchMax) result.add(product);
        }
        ...
        System.out.println("共找到 " + result.size() + " 筆符合預算的商品。");
        return result;
    }
    ...
    public List<Product> filterByPlatform(Scanner scanner) {
        ...
        switch (choice) {
            case 1: selectedPlatform = "博客來"; break;
            case 2: selectedPlatform = "PChome"; break;
            case 3: selectedPlatform = "momo"; break;
            case 4: selectedPlatform = "Yahoo購物"; break;
            default:
        ...
        for (Product product : allProducts) {
            if (product.getPlatform().equals(selectedPlatform)) result.add(product);
        }
        ...
        System.out.println("共找到 " + result.size() + " 筆 " + selectedPlatform + " 商品。");
        return result;
    }
}